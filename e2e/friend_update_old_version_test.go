...
func TestFriendUpdateOldVersion(t *testing.T) {
	NNodes = 2
	isDebug := true
	...
	var sec0_47_0 types.Timestamp
	testCore(t0, bodyString, &sec0_47_0, t, isDebug)

	// 47.1. time-forward.
	var offsetSecond int64 = 86400
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "ptt_setOffsetSecond", "params": [%v]}`, offsetSecond)

	bool0_47_1 := false
	testCore(t0, bodyString, &bool0_47_1, t, isDebug)

	bool1_47_1 := false
	testCore(t1, bodyString, &bool1_47_1, t, isDebug)

	// 47.2. get offset-second
	bodyString = fmt.Sprintf(`{"id": "testID", "method": "ptt_getTimestamp", "params": []}`)

	var sec0_47_2 types.Timestamp
	testCore(t0, bodyString, &sec0_47_2, t, isDebug)
	assert.Equal(sec0_47_0.Ts+offsetSecond, sec0_47_2.Ts)
