...
func TestFriendDeleteFriend5(t *testing.T) {
	...
	dataGetUserName0_24 := &struct {
		Result map[string]*account.BackendUserName `json:"result"`
	}{}

	testListCore(t0, bodyString, dataGetUserName0_24, t, isDebug)
	assert.Equal(2, len(dataGetUserName0_24.Result))

	dataGetUserName1_24 := &struct {
		Result map[string]*account.BackendUserName `json:"result"`
	}{}

	testListCore(t1, bodyString, dataGetUserName1_24, t, isDebug)
	assert.Equal(2, len(dataGetUserName1_24.Result))
