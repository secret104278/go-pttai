...
func TestFriendComment(t *testing.T) {
	...
	assert.Equal(types.StatusDeleted, article0_52_0.Status)
	article0_52_1 := dataGetArticleList0_52.Result[1]
	assert.Equal(types.StatusAlive, article0_52_1.Status)
	...
	assert.Equal(types.StatusDeleted, article1_52_0.Status)
	article1_52_1 := dataGetArticleList1_52.Result[1]
	assert.Equal(types.StatusAlive, article1_52_1.Status)
